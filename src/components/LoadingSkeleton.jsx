...
export const UserSkeleton = () => {
  return (
    <div className="glass-panel w-full max-w-sm overflow-hidden border-t-4 theme-card-border">
      <div className="p-6 flex flex-col items-center">
        <div className="w-[88px] h-[88px] rounded-full skeleton-shimmer mb-4 border theme-card-border"></div>
        ...
        <div className="w-full grid grid-cols-3 gap-3 mb-6">
          <div className="h-16 rounded-lg skeleton-shimmer border theme-card-border minecraft-corners"></div>
          <div className="h-16 rounded-lg skeleton-shimmer border theme-card-border minecraft-corners"></div>
          <div className="h-16 rounded-lg skeleton-shimmer border theme-card-border minecraft-corners"></div>
        </div>
        
        <div className="theme-panel-solid w-full space-y-3 p-4 rounded-xl border">
  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
        {[...Array(4)].map((_, i) => (
          <div key={i} className="glass-panel p-5 h-36 border theme-card-border flex flex-col justify-between minecraft-corners">
            <div>
